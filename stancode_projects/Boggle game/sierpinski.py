...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		triangle_line2 = GLine(upper_left_x,upper_left_y, upper_left_x+length/2 , upper_left_y+length*0.866)
		triangle_line3 = GLine(upper_left_x + length, upper_left_y, upper_left_x+length/2 , upper_left_y+length*0.866)
